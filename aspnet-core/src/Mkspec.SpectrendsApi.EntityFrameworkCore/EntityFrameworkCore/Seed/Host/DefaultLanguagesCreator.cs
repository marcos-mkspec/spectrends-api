...
namespace Mkspec.SpectrendsApi.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = SpectrendsApiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(SpectrendsApiDbContext context)
        {
            _context = context;
        }
